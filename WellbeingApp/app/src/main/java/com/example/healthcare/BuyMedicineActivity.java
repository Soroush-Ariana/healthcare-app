...
public class BuyMedicineActivity extends AppCompatActivity {
    private String[][] packages =
            {
                    {"Uprise-D3 1000IU Capsule", "", "", "", "2"},
                    {"HealthVit Chromium Picolinate 200mcg Capsule", "", "", "", "3"},
                    {"Vitamin B Complex Capsules", "", "", "", "4"},
                    {"Inlife Vitamin E Wheat Germ Oil Capsule", "", "", "", "5"},
                    {"Dolo 650 Tablet", "", "", "", "1"},
                    {"Crocin 650 Advance Tablet", "", "", "", "4"},
                    {"Strepsils Medicated Lozenges for Sore Throat", "", "", "", "3"},
                    {"Tata 1mg Calcium + Vitamin D3", "", "", "", "2"},
                    {"Feronia -XT Tablet", "", "", "", "7"},
            };
